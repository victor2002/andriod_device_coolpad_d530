...
public class CdmaSubscriptionListPreference extends ListPreference {
    ...
    //                           1 - NV
    static final int preferredSubscriptionMode = CDMA_SUBSCRIPTION_RUIM_SIM; //joyfish change CDMA_SUBSCRIPTION_NV; change phone.apk, fix default subscription mode to RUIM
