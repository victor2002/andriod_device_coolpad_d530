...
public abstract class DataConnectionTracker extends Handler {
    ...
    //private DefaultDataNetworkObserver dataNetworkObserver;
    ...
    protected static final int EVENT_GET_DATA_TRANS_STATS_DONE = 39; //+
    protected static final int EVENT_POLL_GET_DATA_TRANS_STATS = 40; //+
    protected static final int EVENT_SMS_INIT_COMPLETED = 41; //+
    ...
    //protected boolean isDefaultNetwork;
    ...
    //protected int defaultDataConnection = 2;
   ...
   /**
    ...
    protected DataConnectionTracker(PhoneBase phone) {
        ...
        this.phone = phone;
        //////////{+
        //LOG_TAG = (new StringBuilder()).append(phonebase.getPhoneName()).append("-").append(LOG_TAG).toString();
        //ContentResolver contentresolver = phone.getContext().getContentResolver();
        //String s = android.provider.Settings.System.getString(contentresolver, "default_data_network");
        /////////////}
    }
    ...
    private void setEnabled(int id, boolean enable) {
        ...
        //if (id == 0 && !isDefaultNetwork)
        //{
        //    Log.d(LOG_TAG, "CP_COMM: We don't enable/disable a none default network if it is a default apn");
        //}
        //else
        //{
