...
public abstract class IccCard {
    ...
    protected void updateStateProperty() {
        if(mPhone.getPhoneName().equals("GSM")) {
            //if (DBG) Log.d(mLogTag, (new StringBuilder()).append("updateStateProperty GSM getState().toString()= ").append(getState().toString()).toString());
            mPhone.setSystemProperty(TelephonyProperties.PROPERTY_SIM_STATE, getState().toString());
        } else {
            //if (DBG) Log.d(mLogTag, (new StringBuilder()).append("updateStateProperty CDMA getState().toString()= ").append(getState().toString()).toString());
            mPhone.setSystemProperty("cdma.ruim.state", getState().toString());
        }
    }
