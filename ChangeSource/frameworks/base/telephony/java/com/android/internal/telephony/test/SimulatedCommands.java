...
public final class SimulatedCommands extends BaseCommands
    ...
    {
       //if (DBG) Log.i("GSM", "[SimCmd] getICCID");
        resultSuccess(message, "89860 30333 02111 90860");
    }
    ...
    ///+
    public void getCardAdnParam1(Message message)
    {
        unimplemented(message);
    }

    public void getCardAdnParam2(Message message)
    {
        unimplemented(message);
    }

    public void getCardSmsInfo(int i, Message message)
    {
        unimplemented(message);
    }

    public void getCardSmsParam(Message message)
    {
        unimplemented(message);
    }

    public void getCardType(Message message)
    {
        unimplemented(message);
    }

    public void getCellID(Message message)
    {
        unimplemented(message);
    }
