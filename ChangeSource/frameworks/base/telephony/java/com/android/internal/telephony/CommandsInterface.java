...
//  static final int CF_ACTION_UNUSED           = 2;
    ...
    void registerForRUIMPBMReady(Handler handler, int i, Object obj);//+
    //void unregisterForRUIMPBMReady(Handler handler);//+
   ...
   /**
    ...
    /////////////////////{+
    void getCardAdnParam1(Message message);
    void getCardAdnParam2(Message message);
    void getCardSmsInfo(int i, Message message);
    void getCardSmsParam(Message message);
    //void getCardType(Message message);

    //void getCellID(Message message);
    //void getDataTransStats(Message message);
    //void getGsmLineNumber(Message message);
    //void getGsmRFCalibration(Message message);
    //void getModemStatus(Message message);
    //void getRFCalibration(Message message);
    //void getSMSCAddr(Message message);
    //void getUtkLocalInfo(Message message);
    //void hold(Message message);
    //void queryPINPUKValidCount(int i, Message message);
    void registerForCdmaFwim(Handler handler, int i, Object obj);
    void registerForCdmaSecret(Handler handler, int i, Object obj);
    //void registerForGpsAltRequest(Handler handler, int i, Object obj);
    //void registerForGpsNotifyRequest(Handler handler, int i, Object obj);
    //void registerForGsmCpi(Handler handler, int i, Object obj);
    void registerForSIMPBMReady(Handler handler, int i, Object obj);
    //void requestEnterCmdMode(Message message);
    //void requestSecrecyConnecting(Message message);
    //void rilIoControl(int i, String s, String s1, Message message);
    //void sendCdmaRawPdu(String s, Message message);
    void sendCdmaSms(CdmaSmsSendStruct cdmasmssendstruct, Message message);
    //void sendCommandFromEngmode(String s, Message message);
    //void sendGpsOneCommand(int i, Message message);
    //void sendPowerState(int i, Message message);
    void setCardPbInfo(int i, String s, int j, String s1, Message message);
    //void setCardProfileDownload(Message message);
    //void setCnmiMode(int i, Message message);
    //void setGpsLocNotify(int i, Message message);
    //void setGpsNotifyResp(int i, Message message);
    //void setGpsPPPDialResult(int i, Message message);
    //void setGpsPPPDiscResult(int i, Message message);
    //void setMBBMSAuthenticate(String s, String s1, Message message);
    //void setRasConnectFunction(int i, Message message);
    //void setSounddevice(int i, Message message);
    //void setVoiceRecord(boolean flag, Message message);
    //void setupDataCall(String s, String s1, String s2, String s3, String s4, String s5, Message message);
    void unregisterForCdmaFwim(Handler handler);
    void unregisterForCdmaSecret(Handler handler);
    //void unregisterForGpsAltRequest(Handler handler);
    //void unregisterForGpsNotifyRequest(Handler handler);
    //void unregisterForGsmCpi(Handler handler);
    void unregisterForRUIMPBMReady(Handler handler);//
    void unregisterForSIMPBMReady(Handler handler);
    void writeSmsToRuimEx(int i, int j, String s, byte abyte0[], String s1, Message message);//+
    void writeSmsToSimEx(int i, int j, byte abyte0[], byte abyte1[], String s, Message message);
    //////////////////////////////////}
    ...
    //+
    //public abstract void setCardPbInfo(int i, String s, int j, String s1, Message message);
    //
    /**
