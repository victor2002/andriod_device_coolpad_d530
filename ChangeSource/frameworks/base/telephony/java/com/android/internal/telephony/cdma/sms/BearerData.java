...
public final class BearerData {
    ...
    private static void encodeMsgCenterTimeStamp(String s, BitwiseOutputStream outStream)
        throws com.android.internal.util.BitwiseOutputStream.AccessException
    {
        ...
        for (i = 0; i < s.length() / 2; i++)
        {
            //BCD to hex
            if (
                    (abyte1[i * 2] <= '9' && abyte1[i * 2] >= '0') && 
                    (abyte1[1 + i * 2] <= '9' && abyte1[1 + i * 2] >= '0')
               ) 
            {
                abyte0[i] = (byte)(((int)(abyte1[i * 2] - '0') << 4) | (int)(abyte1[1 + i * 2] - '0'));
            }
        }
        outStream.write(8, 6);
        outStream.writeByteArray(8 * abyte0.length, abyte0);
    }
    //
   ...
   //+
    public static byte[] encode(BearerData bearerdata, String s)
    {
        byte abyte0[];
        boolean flag;
        ...
        try {
            ...
            if(s != null && s.length() == 12)
            {
                ...
                encodeMsgCenterTimeStamp(s, bitwiseoutputstream);
            }
   ...
   //
    ...
    public static BearerData decode(byte[] smsData) {
        //Log.d("SMS BearData", "enter decode function");
