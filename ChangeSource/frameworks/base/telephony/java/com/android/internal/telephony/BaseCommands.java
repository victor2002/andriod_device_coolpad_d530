...
public abstract class BaseCommands implements CommandsInterface {
    ...
    //***** Instance Variables
    protected Registrant mCdmamFwimRegistrant;//+
    protected Registrant mCdmamSecretRegistrant;//+
    ...
    protected RegistrantList mRUIMPBMReadyRegistrants = new RegistrantList(); //+
    protected RegistrantList mSIMPBMReadyRegistrants = new RegistrantList(); //+
    ...
    ////////////+
    public void registerForSIMPBMReady(Handler handler, int i, Object obj)
    {
        Registrant registrant = new Registrant(handler, i, obj);
        synchronized (mStateMonitor) {
            mSIMPBMReadyRegistrants.add(registrant);
    ...
    //////////////////////+
    public void unregisterForSIMPBMReady(Handler handler)
    {
        synchronized (mStateMonitor) {
            mSIMPBMReadyRegistrants.remove(handler);
        }
    }
    ////////////////////////////
    ...
    /////+
    public void registerForRUIMPBMReady(Handler handler, int i, Object obj)
    {
        Registrant registrant = new Registrant(handler, i, obj);
        synchronized (mStateMonitor) {
            mRUIMPBMReadyRegistrants.add(registrant);
        }
    }
    ///////////////
    ...
    ////////////////////////+
    public void unregisterForRUIMPBMReady(Handler handler)
    {
        synchronized (mStateMonitor) {
            mRUIMPBMReadyRegistrants.remove(handler);
        }
    }
    /////////////////////////
    ...
    /////+
    public void registerForCdmaFwim(Handler handler, int i, Object obj)
    {
        mCdmamFwimRegistrant = new Registrant(handler, i, obj);
    }
    ///////
    ...
    //////+
    public void registerForCdmaSecret(Handler handler, int i, Object obj)
    {
        mCdmamSecretRegistrant = new Registrant(handler, i, obj);
    }
    
    public void unregisterForCdmaFwim(Handler handler)
    {
        mCdmamFwimRegistrant.clear();
    }
    ////////
    ...
    /////////////+
    public void unregisterForCdmaSecret(Handler handler)
    {
        mCdmamSecretRegistrant.clear();
    }
    /////////////
    ...
    //////+
    public void sendCdmaSms(CdmaSmsSendStruct cdmasmssendstruct, Message message)
    {
    }
    ////////
