...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SmsMessage createFromEfRecord(int index, byte[] data) {
        try {
            ...
            System.arraycopy(data, 2, new byte[size], 0, size);
    ...
    //+
    public static SubmitPdu getSubmitPdu(String scAddr, String destAddr, String message, boolean statusReportRequested, SmsHeader smsheader, String s3)
    {
        SubmitPdu submitpdu;
        if(message == null || destAddr == null)
        {
        ...
        } else
        {
            ...
            userdata.payloadStr = message;
            userdata.userDataHeader = smsheader;
            submitpdu = privateGetSubmitPdu(destAddr, statusReportRequested, userdata, s3);
        }
        return submitpdu;
    }
    ///+
    ...
    public static SubmitPdu getSubmitPdu(String scAddr, String destAddr, int destPort,
        ...
        portAddrs.destPort = destPort & 0xffff;
        UserData userdata;
        if(destPort > 65535) //+
            portAddrs.origPort = destPort >> 16;
        else
        ...
        UserData uData = new UserData();
        uData.userDataHeader = null;//smsHeader;
    ...
    */
    /* package */public int getTeleService() {
    ...
    */
            ...
            while (dis.available() > 0) {
                ...
                switch (parameterId) {
                    ...
                    case DESTINATION_ADDRESS://4
                        ...
                        if(addr == null)
                        {
                            Log.e("CDMA", "cdma sms parsePdu addr is NULL");
                            dis.close();
                        }
                        else
                        {
                    ...
                    case BEARER_DATA://8
                        ...
                        bearerDataLength = parameterLen;
                        break;
                    default:
                        //throw new Exception("unsupported parameterId (" + parameterId + ")");
                         Log.e("CDMA", "error tl_parm_id: " + parameterId);
                }
            }
            //bais.close();
            dis.close();
    ...
    public CdmaSmsAddress parseCdmaAddress(byte parameterData[], int nLen)
    {
        ...
        //CdmaSmsAddress cdmasmsaddress1;// = null;
        if(nLen <= 0)
        {
            return null;
            //cdmasmsaddress1 = null;
        ...
        try
        {
            ...
            if(CdmaSmsAddress.DIGIT_MODE_8BIT_CHAR == cdmasmsaddress.digitMode) //1 ==
            {
            ...
            if(cdmasmsaddress.digitMode == CdmaSmsAddress.DIGIT_MODE_8BIT_CHAR &&
            ...
            if(cdmasmsaddress.numberOfDigits > 36)// goto _L5; else goto _L4
            {
                Log.d("CDMA", "parseCdmaAddress numberOfDigits is too long ");
                cdmasmsaddress.numberOfDigits = 36;
                return null;
            }
            else
            {
                byte abyte1[];
                int j;
                cdmasmsaddress.origBytes = new byte[cdmasmsaddress.numberOfDigits];
                abyte1 = new byte[16];
                abyte1[0] = 48;
                abyte1[1] = 49;
                abyte1[2] = 50;
                ...
                abyte1[15] = 67;
                j = 0;
                while (j < cdmasmsaddress.numberOfDigits) //goto _L6; else goto _L7
                {
                    byte byte1 = (byte)bitwiseinputstream.read(byte0);
                    if(byte1 >= 0 && byte1 <= 15)
                        cdmasmsaddress.origBytes[j] = abyte1[byte1];
                    j++;
                }
                return cdmasmsaddress;
            }
        }
        catch  (BitwiseInputStream.AccessException accessexception1)
        {
            Log.e("CDMA", "parseCdmaAddress failed: "+accessexception1);
            return null;
        }

//_L6:
        //cdmasmsaddress1 = cdmasmsaddress;
        //return cdmasmsaddress1;
        //return cdmasmsaddress;
        //return null;
    }
    ...
    protected void parseSms() {
        ...
        if (mBearerData == null)
        {
            //if (DBG) Log.d("CDMA", "CP_COMM:MT (decoded) BearerData = "+mBearerData);
            return;
        }
        ...
        if (mBearerData.messageType == BearerData.MESSAGE_TYPE_DELIVERY_ACK) {
            ...
            if (! mBearerData.messageStatusSet) {
                ...
                (mBearerData.messageType != BearerData.MESSAGE_TYPE_DELIVER) &&
    ...
    //+
  private static SubmitPdu privateGetSubmitPdu(String paramString1, boolean paramBoolean, UserData paramUserData, String paramString2)
  {
      CdmaSmsAddress localCdmaSmsAddress = CdmaSmsAddress.parse(paramString1);
      ...
      byte[] arrayOfByte = BearerData.encode(localBearerData, paramString2);
      ...
      localSmsEnvelope.teleService = 4098;
