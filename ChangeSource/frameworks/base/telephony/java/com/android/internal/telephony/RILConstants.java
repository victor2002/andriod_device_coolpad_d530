...
public interface RILConstants {
    ...
    int RIL_MAX_NETWORKS = 2; //joyfish
    ...
    int NETWORK_MODE_GLOBAL         = 7; /* GSM/WCDMA, CDMA, and EvDo (auto mode, according to PRL)
                                            AVAILABLE Application Settings menu*/ //joy //joyfish
    int NETWORK_MODE_CDMA_AND_LTE_EVDO = 8;               //joyfish
    int NETWORK_MODE_GSM_WCDMA_LTE = 9;    //joyfish
    int NETWORK_MODE_GLOBAL_LTE = 10; //joy //joyfish
    int NETWORK_MODE_LTE_ONLY = 11;        //joyfish

    int PREFERRED_NETWORK_MODE      = NETWORK_MODE_CDMA;// NETWORK_MODE_WCDMA_PREF; //joyfish
    ...
    int PREFERRED_CDMA_SUBSCRIPTION = SUBSCRIPTION_FROM_RUIM;   //joyfish
    ...
    int GSM_PHONE = 1;
    int CDMA_PHONE = 2;
    int SIP_PHONE  = 3; //should be no use in 2.2
...
*/
    ...
    int RIL_REQUEST_REPORT_STK_SERVICE_IS_RUNNING = 103;
                ...
                //////////////joyfish////////////////////////////////////
    int RIL_REQUEST_SET_DEFAULT_RUN_MODE_AND_ACC = 104;
    int RIL_REQUEST_QUERY_RUN_MODE_AND_ACC = 105;
    int RIL_REQUEST_CHANG_SYS_ACCESS_TECH_MODE = 106;
    int RIL_REQUEST_SET_ACCESS_TECH_MODE_ON_TYPE = 107;
    int RIL_REQUEST_SET_ACCESS_TECH_AUTO_SWITCH_MODE = 108;
    int RIL_REQUEST_QUERY_ACCESS_TECH_MODE_ON_TYPE = 109;
    int RIL_REQUEST_SET_ACCTECH_CHANGE_URC = 110;
    int RIL_REQUEST_SET_AUDIO_MODE = 111;
    int RIL_REQUEST_SET_MBBMS_AUTHENTICATE = 112;
    int RIL_REQUEST_GET_MBBMS_CELL_ID = 113;
    int RIL_REQUEST_SMS_PARAM = 114;
    int RIL_REQUEST_CMGR = 115;
    int RIL_REQUEST_CMGW = 116;
    int RIL_REQUEST_PBM_PARAM1 = 117;
    int RIL_REQUEST_PBM_PARAM2 = 118;
    int RIL_REQUEST_CPBR = 119;
    int RIL_REQUEST_CPBW = 120;
    int RIL_REQUEST_GET_CDMA_RF_CAL = 121;
    int RIL_REQUEST_GET_AUDIO_REVISION = 122;
    int RIL_REQUEST_GET_ICCID = 123;
    int RIL_REQUEST_FROM_ENGMODE_COMMAND = 124;
    int RIL_REQUEST_ENTER_CMD_MODE = 125;
    int RIL_REQUEST_SET_POWER_STATE = 126;
    int RIL_REQUEST_QUERY_PINPUK_VALID_COUNT = 127;
    int RIL_REQUEST_HOLD = 128;
    int RIL_REQUEST_SET_RAS_CONNECT = 129;
    int RIL_REQUEST_EXEC_RUIM_ESN_OP = 130;
    int RIL_REQUEST_SET_GPS_DIAL_RESULT = 131;
    int RIL_REQUEST_SET_GPS_DISC_RESULT = 132;
    int RIL_REQUEST_SET_GPS_LOC_NOTIFY = 133;
    int RIL_REQUEST_SET_GPS_NOTIFY_RESP = 134;
    int RIL_REQUEST_IO_CONTROL = 135;
    int RIL_REQUEST_GET_SMSC_ADDR = 136;
    int RIL_REQUEST_GET_DATA_STATS = 137;
    int RIL_REQUEST_GET_GSM_RF_CAL = 138;
    int RIL_REQUEST_GET_CARDTYPE = 139;
    int RIL_REQUEST_MODEM_SLEEP = 140;
    int RIL_REQUEST_MODEM_AWAKE = 141;
    int RIL_REQUEST_GSM_WRITE_SMS_TO_SIM = 142;
    int RIL_REQUEST_GET_MODEM_STATUS = 143;
    int RIL_REQUEST_GET_LINE_NUM = 144;
    int RIL_REQUEST_DEAL_BATTERY_STATUS = 145;
    int RIL_REQUEST_SEND_CDMA_RAW_PDU = 150;
    int RIL_REQUEST_SET_VOICERECORD = 152;
    int RIL_REQUEST_GET_LOCAL_INFO = 153;
    int RIL_REQUEST_SEND_ENGMODE_COMMAND = 154;
    int RIL_REQUEST_VOICE_RADIO_TECH = 186;
    int RIL_REQUEST_CDMA_GET_SUBSCRIPTION_SOURCE = 187; //joyfish
    int RIL_REQUEST_CDMA_PRL_VERSION = 188;//joyfish
    int RIL_REQUEST_IMS_REGISTRATION_STATE = 189;
    int RIL_REQUEST_IMS_SEND_SMS = 190;
    int RIL_REQUEST_SET_UICC_SUBSCRIPTION_SOURCE = 191;
    int RIL_REQUEST_SET_DATA_SUBSCRIPTION_SOURCE = 192;
    int RIL_REQUEST_GET_UICC_SUBSCRIPTION_SOURCE = 193;
    int RIL_REQUEST_GET_DATA_SUBSCRIPTION_SOURCE = 194;
    int RIL_REQUEST_SET_SUBSCRIPTION_MODE = 195;
    int RIL_REQUEST_GET_DATA_CALL_PROFILE = 196;
    int RIL_REQUEST_SET_CNMI_MODE = 197;
    int RIL_REQUEST_SET_GPSONE_OPEN_CLOSE = 198;
    int RIL_REQUEST_SECRECY_CONNETING = 199;

                //////////////////////////////////////
    int RIL_UNDOL_CDMA_SECRET_IND = 1048;
    int RIL_UNSOL_ACCESS_TECHNOLOGY_CHANGED = 1031;
    int RIL_UNSOL_CALL_STATUS_INDICATION = 1032;
    int RIL_UNSOL_CDMA_FWIM_IND = 1038;
    ...
    //////////////////////////////////////////////////////
    int RIL_UNSOL_CDMA_PRL_CHANGED = 1044;
    int RIL_UNSOL_CDMA_SUBSCRIPTION_SOURCE_CHANGED = 1043;
    int RIL_UNSOL_EXIT_EMERGENCY_CALLBACK_MODE = 1046;
    int RIL_UNSOL_GPS_ALT_ONOFF_IND = 1035;
    int RIL_UNSOL_GPS_LOC_Notify_IND = 1036;
    int RIL_UNSOL_GSM_CPI_IND = 1037;
    int RIL_UNSOL_RESEND_INCALL_MUTE = 1039; ////
    int RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED = 1042;
    int RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED = 1045;
    int RIL_UNSOL_RUIM_PBM_STATE_CHNG_IND = 1033;
    int RIL_UNSOL_SIM_PBM_STATE_CHNG_IND = 1034;
    int RIL_UNSOL_SUBSCRIPTION_READY = 1047;
    int RIL_UNSOL_TETHERED_MODE_STATE_CHANGED = 1041;
    int RIL_UNSOL_USIM_SIM_STATE_REPORT = 1030;
    int RIL_UNSOL_VOICE_RADIO_TECH_CHANGED = 1040;

/////////////////
    int SETUP_DATA_CALL_FAILURE = 16;
    int SUBSCRIPTION_NOT_SUPPORTED = 17;
/////////////////////
