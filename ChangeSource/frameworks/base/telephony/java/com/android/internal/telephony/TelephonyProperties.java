...
public interface TelephonyProperties
{
    ...
    //joy big fish for CDMA
    static final String CURRENT_PREFERRED_MODEM = "gsm.current.modem-type";
    static final String PROPERTY_BASEBAND_VERSION_CDMA = "cdma.version.baseband";
    static final String PROPERTY_ICC_OPERATOR_ALPHA_CDMA = "cdma.ruim.operator.alpha";
    static final String PROPERTY_ICC_OPERATOR_ISO_COUNTRY_CDMA = "cdma.ruim.operator.iso-country";
    static final String PROPERTY_ICC_OPERATOR_NUMERIC_CDMA = "cdma.ruim.operator.numeric";
    static final String PROPERTY_OPERATOR_ALPHA_CDMA = "cdma.operator.alpha";
    static final String PROPERTY_OPERATOR_ISO_COUNTRY_CDMA = "cdma.operator.iso-country";
    static final String PROPERTY_OPERATOR_ISROAMING_CDMA = "cdma.operator.isroaming";
    static final String PROPERTY_OPERATOR_NUMERIC_CDMA = "cdma.operator.numeric";
    static final String PROPERTY_RUIM_STATE = "cdma.ruim.state";
    static final String PROPERTY_DATA_NETWORK_TYPE_CDMA = "cdma.network.type";
    static final String PROPERTY_CDMA_NETWORK_MODE = "cdma.network.mode";
    static final String PROPERTY_OPERATOR_NUMERIC_HOME_CDMA = "ro.cdma.home.operator.numeric";
    static final String PROPERTY_GSM_RF_CAL = "gsm.locosto.rf.cal";
    static final String PROPERTY_GSM_RF_COL = "gsm.locosto.rf.col";
    static final String PROPERTY_GSM_RF_IMEI = "gsm.locosto.rf.imei";
    static final String PROPERTY_GSM_RF_VER = "gsm.locosto.rf.ver";
