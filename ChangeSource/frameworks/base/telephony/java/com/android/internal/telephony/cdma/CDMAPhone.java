...
import static com.android.internal.telephony.TelephonyProperties.PROPERTY_ICC_OPERATOR_ISO_COUNTRY_CDMA;
...
public class CDMAPhone extends PhoneBase {
    ...
    public CDMAPhone(Context context, CommandsInterface ci, PhoneNotifier notifier,
        ...
        setSystemProperty("cdma.ruim.operator.alpha", operatorAlpha);

        // Sets operator numeric property by retrieving from build-time system property
        String operatorNumeric = SystemProperties.get("ro.cdma.home.operator.numeric");
        setSystemProperty("cdma.ruim.operator.numeric", operatorNumeric);
        ...
        //MccTable.updateMccMncConfiguration(this, operatorNumeric); //2.2
    ...
    public String getLine1Number() {
        ...
        String sMdn = mSST.getMdnNumber();
        if(sMdn != null && sMdn.equals(""))
            sMdn = getVoiceMailNumber();
        return sMdn;
    }
    ...
    public CellLocation getCellLocation() {
        if (DBG) Log.d("CDMA", (new StringBuilder()).append("CDMAPhone getCellLocation mSST.cellLoc is ").append(mSST.cellLoc).toString());
        return mSST.cellLoc;
    }
   ...
   /**
    ...
    private void setIsoCountryProperty(String operatorNumeric) {
        if (TextUtils.isEmpty(operatorNumeric)) {
            ...
            setSystemProperty(PROPERTY_ICC_OPERATOR_ISO_COUNTRY_CDMA, "");
        } else {
            String iso = "";
            try {
            ...
            setSystemProperty(PROPERTY_ICC_OPERATOR_ISO_COUNTRY_CDMA, iso);// PROPERTY_ICC_OPERATOR_ISO_COUNTRY, iso);
        }
    }
    ...
    boolean updateCurrentCarrierInProvider(String operatorNumeric) {
        if (!TextUtils.isEmpty(operatorNumeric)) {
            try {
                ...
                //Log.d("CDMA", "updateCurrentCarrierInProvider for cdma ()");
