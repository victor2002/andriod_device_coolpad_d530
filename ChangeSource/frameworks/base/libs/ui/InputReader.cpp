...
extern "C" void loadPointercalData(const char* filename);

int32_t a01,a02,a03,a04,a05,a06,a07;
...
#ifdef HAS_POINTERCAL
        //LOGD("mx my %d %d\n", mX, mY);
        mCurrentTouch.pointers[0].x = (mX*a01 + mY*a02 + a03)/a07;
        mCurrentTouch.pointers[0].y = (mX*a04 + mY*a05 + a06)/a07;
...
extern "C" void loadPointercalData(const char* filename)
{
    ...
    if(result == NULL)
	return;
    int32_t temp_a01 = atoi(result);

    result = strtok( NULL, delims );
    if(result == NULL)
	return;
    int32_t temp_a02 = atoi(result);

    result = strtok( NULL, delims );
    if(result == NULL)
	return;
    int32_t temp_a03 = atoi(result);

    result = strtok( NULL, delims );
    if(result == NULL)
	return;
    int32_t temp_a04 = atoi(result);

    result = strtok( NULL, delims );
    if(result == NULL)
	return;
    int32_t temp_a05 = atoi(result);

    result = strtok( NULL, delims );
    if(result == NULL)
	return;
    int32_t temp_a06 = atoi(result);
